...
public class InformeProveedorViewController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		dataListView.add(Main.PROVTOTALFACTPORMESES);
	...
	public void showReport() {
		...
		case Main.PROVTOTALFACTPORMESES:
			ReportViewer.showTotalPorMesesReport(Main.PROVTOTALFACTPORMESES);
			break;
		}
		}catch(Exception e) {
